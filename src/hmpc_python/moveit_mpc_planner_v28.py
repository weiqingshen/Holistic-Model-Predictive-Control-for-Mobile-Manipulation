...
from mpc_planner_v28 import MPCPlannerV28
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv28(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v28')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV28(self.get_logger(), self.urdf_path,self.valid_steps )
        ...
        self.get_logger().info("MoveIt MPC Planner v28 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv28(target_pose)
