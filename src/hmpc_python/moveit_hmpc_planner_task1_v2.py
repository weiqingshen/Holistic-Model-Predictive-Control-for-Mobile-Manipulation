...
from hmpc_planner_task1_v2 import HMPCPlanner_task1_v2
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItHMPCPlanner_task1_v2(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_hmpc_planner_task1_v2')
        ...
        # 初始化 MPC 优化器
        self.mpc = HMPCPlanner_task1_v2(self.get_logger(), self.urdf_path,self.valid_steps )
        ...
        self.get_logger().info("MoveIt HMPC Planner task1_v2 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItHMPCPlanner_task1_v2(target_pose)
