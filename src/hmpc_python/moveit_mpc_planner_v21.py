...
from mpc_planner_v21 import MPCPlannerV21
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv21(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v21')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV21(self.get_logger(), urdf_path,self.valid_steps)
        ...
        self.get_logger().info("MoveIt MPC Planner v21 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv21(target_pose)
