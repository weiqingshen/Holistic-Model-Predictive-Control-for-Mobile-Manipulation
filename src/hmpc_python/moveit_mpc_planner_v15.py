...
from mpc_planner_v15 import MPCPlannerV15
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv15(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v15')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV15(self.get_logger(), urdf_path)
        ...
        self.get_logger().info("MoveIt MPC Planner v15 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv15(target_pose)
