...
from hmpc_planner_task1_v1 import HMPCPlanner_task1_v1
import numpy as np
import casadi as ca
import time
import sys
...
from spherical_decomposition.final_main_v8 import symbolic_collision_analysis

class MoveItHMPCPlanner_task1_v1(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_hmpc_planner_task1_v1')
        ...
        # 初始化 MPC 优化器
        self.mpc = HMPCPlanner_task1_v1(self.get_logger(), self.urdf_path,self.valid_steps )
        ...
        self.get_logger().info("MoveIt HMPC Planner task1_v1 启动完成")
    ...
    def run_mpc_dynamic(self):
        ...
        # self.mpc.set_symbolic_collision_constraints(symbolic_result, danger_threshold=0.08, a=100, b=500)
        # custom_params = {
        #     ("link_left", "cylinder"): {'danger_threshold': 0.08, 'a': 0.5, 'b': 220},
        #     ("cylinder", "link_left"): {'danger_threshold': 0.08, 'a': 0.5, 'b': 220},
        #     ("cylinder", "link_right"): {'danger_threshold': 0.08, 'a': 0.5, 'b': 220},
        #     ("link_right", "cylinder"): {'danger_threshold': 0.08, 'a': 0.5, 'b': 220},
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItHMPCPlanner_task1_v1(target_pose)
