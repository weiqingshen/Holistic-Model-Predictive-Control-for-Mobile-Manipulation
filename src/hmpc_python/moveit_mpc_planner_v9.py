...
from mpc_planner_v9 import MPCPlannerV9
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv9(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v9')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV9(self.get_logger(), urdf_path)
        ...
        self.get_logger().info("MoveIt MPC Planner v9 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv9(target_pose)
