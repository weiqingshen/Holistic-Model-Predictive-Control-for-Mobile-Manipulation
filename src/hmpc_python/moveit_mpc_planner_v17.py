...
from mpc_planner_v17 import MPCPlannerV17
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv17(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v17')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV17(self.get_logger(), self.urdf_path,self.valid_steps )
        ...
        self.get_logger().info("MoveIt MPC Planner v17 启动完成")
    ...
    def publish_trajectory(self):
        ...
        key_point_steps = [10, 15, 20, 25]  # 对应时间步
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv17(target_pose)
