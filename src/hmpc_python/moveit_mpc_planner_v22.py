...
from mpc_planner_v22 import MPCPlannerV22
import numpy as np
import casadi as ca
import time
import sys
...
import pandas as pd
import os
class MoveItMPCPlannerv22(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v22')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV22(self.get_logger(), self.urdf_path,self.valid_steps )
        ...
        self.get_logger().info("MoveIt MPC Planner v22 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv22(target_pose)
