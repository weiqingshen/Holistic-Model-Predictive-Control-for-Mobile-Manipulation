...
from mpc_planner_v29 import MPCPlannerV29
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv29(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v29')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV29(self.get_logger(), urdf_path,self.valid_steps)
        ...
        self.get_logger().info("MoveIt MPC Planner v29 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv29(target_pose)
