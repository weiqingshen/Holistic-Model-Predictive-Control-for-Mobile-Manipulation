...
from mpc_planner_v23 import MPCPlannerV23
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv23(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v23')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV23(self.get_logger(), urdf_path,self.valid_steps)
        ...
        self.get_logger().info("MoveIt MPC Planner v23 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv23(target_pose)
