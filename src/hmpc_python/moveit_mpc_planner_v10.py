...
from mpc_planner_v10 import MPCPlannerV10
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv10(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v10')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV10(self.get_logger(), urdf_path)
        ...
        self.get_logger().info("MoveIt MPC Planner v10 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv10(target_pose)
