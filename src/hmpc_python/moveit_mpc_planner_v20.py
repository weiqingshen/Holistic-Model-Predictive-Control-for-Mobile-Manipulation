...
from mpc_planner_v20 import MPCPlannerV20
import numpy as np
import casadi as ca
import time
import sys
...
class MoveItMPCPlannerv20(Node):
    def __init__(self, target_pose=None):
        super().__init__('moveit_mpc_planner_v20')
        ...
        # 初始化 MPC 优化器
        self.mpc = MPCPlannerV20(self.get_logger(), self.urdf_path,self.valid_steps )
        ...
        self.get_logger().info("MoveIt MPC Planner v20 启动完成")
...
def main(args=None):
    ...
    # 初始化节点
    node = MoveItMPCPlannerv20(target_pose)
