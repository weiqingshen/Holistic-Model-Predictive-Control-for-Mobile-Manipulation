...
int main(int argc, char *argv[]) {
    ...
    pose1_origin.position.x = 0.2586; pose1_origin.position.y = 1+0.27; pose1_origin.position.z = 3;
    pose2_origin.position.x = -0.01856; pose2_origin.position.y = 1+0.27; pose2_origin.position.z = 1;
    pose3_origin.position.x = 0.12; pose3_origin.position.y = 1+0.51; pose3_origin.position.z = 2;
