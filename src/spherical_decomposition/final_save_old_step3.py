...
# 主函数：返回最短球对对应的符号距离表达式等信息
def get_symbolic_transforms_of_closest_spheres(saved_json_path="output_results.json"):
    ...
    for item in saved_data["min_distances"]:
        ...
        # 替代 simplify：速度快，效果足够
        dist_expr = sp.nsimplify(dist_expr, rational=True)
