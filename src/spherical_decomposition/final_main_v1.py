import time
from .final_symbolic_transform_v1 import get_symbolic_transforms_of_closest_spheres
...
def symbolic_collision_analysis(joint_angles, sphere_json_path="link_spheres_relative.json"):
    """
