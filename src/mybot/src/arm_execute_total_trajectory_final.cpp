...
int main(int argc, char** argv) {
    ...
    manipulator_action.executeAction_trajectory(object1, place_pose1, grasp_pose,"","","circle11","circle12");

    manipulator_action.executeAction_trajectory(object2, place_pose2, grasp_pose,"","","circle21","circle22");
    //manipulator_action.executeAction_trajectory(object21, place_pose2, grasp_pose,"","","","");

    manipulator_action.executeAction_trajectory(object3, place_pose3, grasp_pose,"","","circle31","circle32");
    ...
    place_pose1.setTargetPose(0, -0.1994, 0.408, 0, 1, 0, 0);
    place_pose2.setTargetPose(0.09, -0.1994, 0.408, 0, 1, 0, 0);
    place_pose3.setTargetPose(0.108, -0.1094, 0.408, 0, 1, 0, 0);
    ...
    manipulator_action.moveAction(object1,grasp_pose,"processing11");
    node_communication->waitForMessage();
    place_pose1.setTargetPose(0.0, 0.2, 0.4, 0, 1, 0, 0);
    manipulator_action.graspAction_trajectory(object1, place_pose1, grasp_pose,"","processing12");

    node_communication->waitForMessage();
    node_communication->getPosition(target1);
    place_pose1.setTargetPose(target1.x1, target1.y1, 0.115, 0, 1, 0, 0);
    manipulator_action.placeAction(object1,place_pose1,grasp_pose);
    place_pose2.setTargetPose(0.0, 0.2, 0.4, 0, 1, 0, 0);
    manipulator_action.graspAction_trajectory(object2, place_pose2, grasp_pose,"processing21","processing22");
    ...
    Object object21(move_group_node, "cylinder1");
    object21.setPosition(target1.x1,target1.y1,0.115);
    collision_objects2.push_back(object21.getCollisionObject());
    planning_scene_interface.addCollisionObjects(collision_objects2);

    place_pose2.setTargetPose(target1.x2, target1.y2, 0.115, 0, 1, 0, 0);
    manipulator_action.placeAction(object2,place_pose2,grasp_pose);

    place_pose3.setTargetPose(0.0, 0.2, 0.4, 0, 1, 0, 0);
    manipulator_action.graspAction_trajectory(object3, place_pose3, grasp_pose,"processing31","processing32");

    std::vector<std::string> objects_to_remove2 = {object21.getName(),object2.getName()};
    planning_scene_interface.removeCollisionObjects(objects_to_remove2);
    node_communication->waitForMessage();
    node_communication->getPosition(target1);
    Object object31(move_group_node, "cylinder1");
    Object object32(move_group_node, "cylinder2");

    object31.setPosition(target1.x1,target1.y1,0.115);
    object32.setPosition(target1.x2,target1.y2,0.115);
    collision_objects3.push_back(object31.getCollisionObject());
    collision_objects3.push_back(object32.getCollisionObject());
    planning_scene_interface.addCollisionObjects(collision_objects3);


    place_pose3.setTargetPose(target1.x3, target1.y3, 0.115, 0, 1, 0, 0);
    manipulator_action.placeAction(object3,place_pose3,grasp_pose);
