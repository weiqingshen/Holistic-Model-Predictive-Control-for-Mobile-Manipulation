    ...
    bool add_top = true)
{
                          ...
                          double pos_x, double pos_y, double pos_z)
    {
        ...
        color.color.g = 1.0f;
        color.color.b = 1.0f;
        color.color.a = 0.1f;  // 透明度 (0.0完全透明, 1.0完全不透明)
...
int main(int argc, char** argv) {
    ...
    // object1.setPosition(target1.x1,target1.y1,0.042);
    ...
    manipulator_action.execution_hmpc(object1, place_pose1, grasp_pose);
